...
def getICMPort(port):
    if port == 10007:
        ...
        return 6000
    elif port >= 5004 and port < 5008:
        return 6004
    elif port >= 5008 and port < 5012:
        return 6008
    elif port >= 5012 and port < 5016:
        return 6012
    else:
...
def setupFilterWheel(fStrength0, fStrength1):
    fw0, fw1 = setup_fw(no_check=True)
    change_filter_str(fw0, fStrength0, fw1, fStrength1)
