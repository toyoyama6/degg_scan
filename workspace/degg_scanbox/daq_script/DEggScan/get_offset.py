...
def prepare_metadata(run_file, filepath, comment, fStrength, laser_freq, nevents,
                     n_rapcals):
...
def run_timing(run_file, comment, n_jobs, filepath, r_point, t_point, 
    ...
    icm_ports, key, filepath, ignoreList = prepare_metadata(run_file, filepath, comment,
